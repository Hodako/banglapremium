...
export const metadata: Metadata = {
  title: 'Our Story | Bangla Premium',
  description: 'Learn about the history and mission of Bangla Premium.',
};
