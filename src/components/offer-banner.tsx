...
export function OfferBanner() {
  ...
  return (
    <div className="relative bg-accent text-accent-foreground">
      <div className="container mx-auto flex h-12 items-center justify-center px-4 text-center text-sm font-medium">
        <Gift className="mr-2 h-4 w-4" />
        <span>Special Offer! Get 20% off on all professional subscriptions. Use code: PRO20</span>
        <Button
          variant="ghost"
          size="icon"
          className="absolute right-4 top-1/2 -translate-y-1/2 h-8 w-8 hover:bg-accent/50"
